Pod::Spec.new do |s|
  ...
  s.name         = "zolozkit"
  s.version      = "2.2.1.260707143443-xcframework"
  ...
  s.source = { :http => 'https://zasia.oss-cn-beijing.aliyuncs.com/ios/framework/2.2.1xc/2.2.1.260707143443-xcframework.zip' }
  s.frameworks = "AVFoundation", "OpenGLES","CoreTelephony", "CoreMotion", "CoreLocation", "SystemConfiguration", "Accelerate", "CoreMedia","CoreServices","CoreGraphics","QuartzCore","CoreVideo","CoreImage", "WebKit", "Vision","AppTrackingTransparency","AdSupport","Security","VideoToolbox"
  s.libraries = 'c++', 'z','resolv'
  s.subspec 'Core' do |core|
    core.vendored_frameworks = 'zolozkit.xcframework','hummer.xcframework','ZolozIdentityManager.xcframework','BioAuthEngine.xcframework','BioAuthAPI.xcframework','ZLZProtoBufferLite.xcframework','ToygerService.xcframework','ToygerServiceAlgo.xcframework'
  ...
  s.subspec 'ZolozNfcIDReader' do |ss|
    ss.vendored_frameworks = 'ZolozNfcIDReader.xcframework'
    ss.framework = "CoreNFC"
  end
  s.subspec 'xNN' do |ss|
    ss.vendored_frameworks = 'xNN.xcframework'
  end
  
  s.subspec 'ZolozVideoVerify' do |ss|
    ss.vendored_frameworks = 'ZVideoVerify.xcframework'
    ss.framework = "Speech","VideoToolbox"
  end
    s.subspec 'ZLocationCheck' do |ss|
    ss.vendored_frameworks = 'ZLocationCheck.xcframework'
  end
