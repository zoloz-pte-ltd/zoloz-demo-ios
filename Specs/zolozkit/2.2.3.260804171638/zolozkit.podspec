Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://hk-production-cdn.zoloz.net/ios/zolozkit_2.2.3.260804171638.zip' }
  ...
  s.subspec 'ZolozNfcIDReader' do |ss|
    ss.vendored_frameworks = 'ZolozNfcIDReader.framework'
    ss.framework = "CoreNFC"
  end
  s.subspec 'xNN' do |ss|
    ss.vendored_frameworks = 'xNN.framework'
  end
  
  s.subspec 'ZolozVideoVerify' do |ss|
    ss.vendored_frameworks = 'ZVideoVerify.framework','nuisdk.framework'
    ss.framework = "AVFoundation","AudioToolbox","AdSupport","VideoToolbox"
    ss.libraries = "iconv"
  end
    s.subspec 'ZLocationCheck' do |ss|
    ss.vendored_frameworks = 'ZLocationCheck.framework'
  end
