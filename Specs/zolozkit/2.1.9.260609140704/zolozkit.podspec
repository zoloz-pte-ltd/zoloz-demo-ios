Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://hk-production-cdn.zoloz.net/ios/zolozkit_2.1.9.260609140704.zip' }
  ...
  s.subspec 'ZolozVideoVerify' do |ss|
    ss.vendored_frameworks = 'ZVideoVerify.framework'
